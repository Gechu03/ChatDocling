...
class OpenAITokenizerWrapper(PreTrainedTokenizerBase):
    """Minimal wrapper for OpenAI's tokenizer, compatible with HybridChunker."""
    ...
    def __init__(self, model_name: str = "cl100k_base", max_length: int = 8191, **kwargs):
        ...
        self._vocab_size = self.tokenizer.n_vocab   # ✅ corrected
    ...
    def __len__(self) -> int:   # ✅ fixes your crash
